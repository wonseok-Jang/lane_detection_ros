...
import torch
from utils.util_hourglass import *
from copy import deepcopy
import numpy as np
from torch.autograd import Variable
from utils.hourglass_network import lane_detection_network
from torch.autograd import Function as F
from config.parameters import Parameters
import math
import utils.util as util
import utils.hard_sampling as hard_sampling
...
class Agent(nn.Module):
    ...
    def __init__(self):
        ...
        print("  Model parameters: {0:d}".format(self.count_parameters(self.lane_detection_network)))
...
#        )
    def load_weights(self, path):
        self.lane_detection_network.load_state_dict(
            torch.load(path, map_location='cuda:0'), False
        )
